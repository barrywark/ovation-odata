...
public class InMemoryProducerExample {
	public static final Logger _log = Logger.getLogger(InMemoryProducerExample.class);
    ...
    public static JerseyServer startODataServer(String baseUri) {
        ...
        server.addJerseyRequestFilter(LoggingFilter.class); // log all requests - TODO not sure what this must subclass
